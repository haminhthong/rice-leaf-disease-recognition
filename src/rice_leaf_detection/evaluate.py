...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Đánh giá YOLOv8 trên validation hoặc test")
    ...
    parser.add_argument("--confirm-final-test", action="store_true",
                        help="Bắt buộc khi --split test để hạn chế test leakage")
...
def main() -> None:
    ...
    if args.split == "test" and not args.confirm_final_test:
        raise SystemExit(
            ...
            "đã chọn mô hình bằng tập validation."
        )
